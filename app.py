...
if st.button('AI Pal'):
        ...
        chatbot_link = "https://9b1a0434559c4ab228.gradio.live/"  # Replace with your actual chatbot URL
        webbrowser.open(chatbot_link)
        st.button("Hey! My Friendo", st.sidebar.open(chatbot_link))
